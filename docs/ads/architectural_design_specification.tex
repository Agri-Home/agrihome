...
\begin{versionhistory}
	...
	\vhEntry{3.0}{07.23.2026}{Team}{Summer update: Pi/Moonraker edge layer, Devices UI, capture APIs}
	\vhEntry{3.1}{07.28.2026}{Team}{Klipper edge: fswebcam primary capture; klipper\_url rename}
\end{versionhistory}
\newpage
...
\input{tex/project_overview.tex}
\newpage
...
\input{tex/subsystems_data.tex}
\newpage

\section{Presentation Layer Subsystems}
\input{tex/subsystems_presentation.tex}
\newpage

\section{Application Layer Subsystems}
\input{tex/subsystems_application.tex}
\newpage

\section{Processing Layer Subsystems}
\input{tex/subsystems_processing.tex}
\newpage

\section{Hardware Layer Subsystems}
\input{tex/subsystems_hardware.tex}
\newpage
...
\bibitem{klipper}
Agri-Home. ``klipper'' companion firmware (camera-macros / fswebcam). \url{https://github.com/Agri-Home/klipper} (accessed 2026).
\bibitem{moonraker}
Arksine et al. ``Moonraker: API Web Server for Klipper.'' \url{https://moonraker.readthedocs.io/} (accessed 2026). Historical companion; AgriHome agent package still lives under Agri-Home/moonraker.

\bibitem{edgeops}
Agrihome. \textit{Raspberry Pi + Klipper} operations guide (\texttt{docs/ops/RASPBERRY\_PI\_KLIPPER.md}), 2026. (Moonraker guide superseded stub.)
\end{thebibliography}
