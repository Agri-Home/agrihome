    ...
    <div className="space-y-6">
      ...
      <section className="animate-fade-in stagger-5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/plants/new" className="text-xs font-semibold text-leaf transition-colors hover:text-leaf/80">
            + Add
          </Link>
        </div>
        ...
        {plants.length === 0 && (
          <Card className="p-6 text-center">
            ...
            <Link href="/plants/new" className="mt-2 inline-block text-sm font-semibold text-leaf">Add a plant</Link>
          </Card>
        )}
      </section>
